...
export const routes: Routes = [
    { 
        ...
        component: PagesComponent, children: [
            ...
            { path: 'comptabilite', loadChildren: () => import('./pages/comptabilite/comptabilite.module').then(m => m.ComptabiliteModule), data: { breadcrumb: 'Comptabilité' } },
    ...
    { path: 'e-mail', loadChildren: () => import('./pages/email/email.module').then(m => m.EmailModule) },
